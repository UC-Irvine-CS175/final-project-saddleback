...
class BPSDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str):
        ...
        if stage == "train":
            ...
            self.train_dataset = BPSMouseDataset(
        ...
        if stage == "validate":
            ...
            self.validate_dataset = BPSMouseDataset(
        ...
        if stage == "test":
            self.test_dataset = BPSMouseDataset(
...
def main():
    ...
    train_csv_file = 'meta_train.csv'
    train_dir = data_dir / 'processed'
    validation_csv_file = 'meta_test.csv'
